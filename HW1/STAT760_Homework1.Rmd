...
P(X \geq m) = \frac{1}{2}
$$
by the definition of the median. The points $x_i$ are independent distibuted over the ball, so

$$ \begin{aligned}
P(X \geq m) = \prod_{i=1}^{N}P(||x_i|| > m) = \frac{1}{2}
\end{aligned}
$$
...
$$\begin{aligned}
P(||x_i|| <m)&=\frac{\text{volume of the p-ball with radius m centered at origin}}{\text{volume of whole ball with radius 1 centered at the origin}} \\
&= \frac{\pi m^p}{\pi 1^p} \\
&= m^p
\end{aligned}
$$
