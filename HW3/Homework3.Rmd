...
Suppose we have features $x \in R^p$, a two-class response, with class sizes N1,N2, and the target coded as $−N/N1,N/N2$.

(a) Show that the LDA rule classifies to class 2 if xT ˆΣ−1(ˆμ2 −ˆμ1) >1 2 ˆμT2 ˆΣ−1 ˆμ2 −1 2 ˆμT1 ˆΣ−1 ˆμ1 + log(N1/N) −log(N2/N), and class 1 otherwise.
